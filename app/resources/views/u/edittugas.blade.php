        ...
        <div class="container">
            ...
            <div class="row">
                <div class="mb-3">
                    ...
                    <textarea id="summernote" name="task_description">{{ $data->task_description }}</textarea>
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <input name='deadline' type="date" id="datepicker" class="form-control border-secondary"
                        placeholder="Input Date and Time" aria-describedby="basic-addon1" value="{{ $data->deadline }}">
